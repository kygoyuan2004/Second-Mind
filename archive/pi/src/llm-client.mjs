...
import { DEFAULT_PI_CONTEXT_WINDOW_TOKENS } from './pi-context-policy.mjs';
import { createPinnedModelFetch, modelTransportInternals } from '../../../src/model-transport.mjs';
export { createPinnedModelFetch };
const { abortReason, resolvePublicModelTarget } = modelTransportInternals;
...
export class ChatModelClient {
  ...
  piBinding() {
    ...
    const binding = {
      ...
      contextWindow: Number(this.config.contextWindow) || DEFAULT_PI_CONTEXT_WINDOW_TOKENS,
